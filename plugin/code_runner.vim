...
function! _VimCodeRunnerRunCases(file_ext, run_type, markdown_tag, selected_text, is_in_container, shebang_lang_pass)
  ...
  elseif (_VimCodeRunnerIsRunTypeCorrect(run_type, 'pgsql', 'psql') || (run_type == '' && (file_ext == 'pgsql' || markdown_tag == 'pgsql' || file_ext == 'psql' || markdown_tag == 'psql')))
    let case_values = _VimCodeRunnerRunPsql(selected_text, is_in_container)
  elseif (_VimCodeRunnerIsRunTypeCorrect(run_type, 'redis', 'redis-cli') || (run_type == '' && (file_ext == 'redis' || markdown_tag == 'redis')))
    let case_values = _VimCodeRunnerRunRedis(selected_text, is_in_container)
  elseif (_VimCodeRunnerIsRunTypeCorrect(run_type, 'sqlite', 'sqlite3') || (run_type == '' && (file_ext == 'sqlite' || markdown_tag == 'sqlite')))
    let case_values = _VimCodeRunnerRunSqlite(selected_text, is_in_container)
  elseif (_VimCodeRunnerIsRunTypeCorrect(run_type, 'mongodb', 'mongo') || (run_type == '' && (file_ext == 'mongodb' || markdown_tag == 'mongodb')))
    let case_values = _VimCodeRunnerRunMongoDb(selected_text, is_in_container)
  elseif (_VimCodeRunnerIsRunTypeCorrect(run_type, 'mssql', 'sqlcmd') || (run_type == '' && (file_ext == 'mssql' || markdown_tag == 'mssql')))
    let case_values = _VimCodeRunnerRunMssql(selected_text, is_in_container)
  elseif (_VimCodeRunnerIsRunTypeCorrect(run_type, 'mysql') || (run_type == '' && (file_ext == 'mysql' || markdown_tag == 'mysql')))
    let case_values = _VimCodeRunnerRunMysql(selected_text, is_in_container)
  elseif (_VimCodeRunnerIsRunTypeCorrect(run_type, 'zsh') || (run_type == '' && (file_ext == 'zsh' ||  markdown_tag == 'zsh')))
    let case_values = _VimCodeRunnerRunZsh(selected_text, is_in_container)
  elseif (_VimCodeRunnerIsRunTypeCorrect(run_type, 'bash') || (run_type == '' && (file_ext == 'bash' || markdown_tag == 'bash')))
    let case_values = _VimCodeRunnerRunBash(selected_text, is_in_container)
  elseif (_VimCodeRunnerIsRunTypeCorrect(run_type, 'cmd', 'bat') || (run_type == '' && (file_ext == 'bat' || markdown_tag == 'bat')))
    let case_values = _VimCodeRunnerRunBat(selected_text, is_in_container)
  elseif (_VimCodeRunnerIsRunTypeCorrect(run_type, 'python') || (run_type == '' && (&filetype == 'python' || markdown_tag == 'python')))
    let case_values = _VimCodeRunnerRunPython(selected_text, is_in_container)
  elseif (_VimCodeRunnerIsRunTypeCorrect(run_type, 'javascript', 'node') || (run_type == '' && (&filetype == 'javascript' || markdown_tag == 'javascript')))
    let case_values = _VimCodeRunnerRunJavascript(selected_text, is_in_container)
  elseif (_VimCodeRunnerIsRunTypeCorrect(run_type, 'typescript', 'ts-node') || (run_type == '' && (&filetype == 'typescript' || markdown_tag == 'typescript')))
    let case_values = _VimCodeRunnerRunTypescript(selected_text, is_in_container)
  elseif (_VimCodeRunnerIsRunTypeCorrect(run_type, 'php') || (run_type == '' && (&filetype == 'php' || markdown_tag == 'php')))
    let case_values = _VimCodeRunnerRunPhp(selected_text, is_in_container)
  elseif (_VimCodeRunnerIsRunTypeCorrect(run_type, 'ruby') || (run_type == '' && (&filetype == 'ruby' || markdown_tag == 'ruby')))
    let case_values = _VimCodeRunnerRunRuby(selected_text, is_in_container)
  elseif (_VimCodeRunnerIsRunTypeCorrect(run_type, 'perl') || (run_type == '' && (&filetype == 'perl' || markdown_tag == 'perl')))
    let case_values = _VimCodeRunnerRunPerl(selected_text, is_in_container)
  elseif (_VimCodeRunnerIsRunTypeCorrect(run_type, 'powershell', 'pwsh') || (run_type == '' && (&filetype == 'ps1' || markdown_tag == 'powershell')))
